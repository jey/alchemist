...
inputfile="/global/cscratch1/sd/gittens/large-datasets/ocean.h5"
dataset="rows"
partitions=1400
...
spark-submit --verbose\
  ...
  test/target/scala-2.11/alchemist-tests-assembly-0.0.2.jar $inputfile $dataset $partitions 2>&1 | tee test.log
